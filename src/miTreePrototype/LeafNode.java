...
/**
 * Klasa węzłów, które znajdują się na samym dole drzewa.
 * Strony odpowiadające ich kluczom przechowują nie węzły, ale wartości.
...
public class LeafNode<K extends Comparable<K>, V> extends Node<K, V> implements Serializable {
	...
	/**
	 * Zwraca wartość przechowywaną na wskazanym indeksie w węźle.
	 * @param index Indeks wartości w węźle.
	...
	/**
	 * Szuka, gdzie w węźle znajduje się dany klucz.
	 * @param key Klucz, który ma być znaleziony.
	 * @return Miejsce, gdzie znajduje się klucz. -1, jeśli nie ma takiego klucza.
	 */
